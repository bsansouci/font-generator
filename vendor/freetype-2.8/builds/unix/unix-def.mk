...
MKINSTALLDIRS   := /Users/sansouci/Desktop/font-generator/vendor/freetype-2.8/builds/unix/./install-sh -c -d
...
#
prefix       := /Users/sansouci/Desktop/font-generator/vendor/freetype-2.8/release
exec_prefix  := ${prefix}
...
#
REQUIRES_PRIVATE   := harfbuzz >= 0.9.21
LIBS_PRIVATE       := 
LIBSSTATIC_CONFIG  := -lfreetype -L/usr/local/Cellar/harfbuzz/1.4.7/lib -L/usr/local/Cellar/glib/2.52.3/lib -L/usr/local/opt/gettext/lib -L/usr/local/Cellar/pcre/8.40/lib -L/usr/local/Cellar/pcre/8.41/lib -L/usr/local/Cellar/graphite2/1.3.10/lib -lharfbuzz -framework ApplicationServices -lglib-2.0 -lintl -Wl,-framework -Wl,CoreFoundation -lpcre -lintl -Wl,-framework -Wl,CoreFoundation -liconv -Wl,-framework,Carbon -Wl,-framework,Foundation -lpcre -D_THREAD_SAFE -pthread -lgraphite2
build_libtool_libs := 
ft_version         := 20.0.14
