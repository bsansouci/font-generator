...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -DDARWIN_NO_CARBON -I/usr/local/Cellar/harfbuzz/1.4.7/include/harfbuzz -I/usr/local/Cellar/glib/2.52.3/include/glib-2.0 -I/usr/local/Cellar/glib/2.52.3/lib/glib-2.0/include -I/usr/local/opt/gettext/include -I/usr/local/Cellar/pcre/8.41/include -I/usr/local/Cellar/graphite2/1.3.10/include -DFT_CONFIG_OPTION_USE_HARFBUZZ -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -L/usr/local/Cellar/harfbuzz/1.4.7/lib -lharfbuzz
